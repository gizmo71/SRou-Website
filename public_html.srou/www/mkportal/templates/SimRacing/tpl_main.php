...
<!-- begin logostrip (plan B) -->
  	<tr>	  <td id="mklogostrip" width="100%">          <a href="$mklib->siteurl/index.php">          <!-- H2>SimRacing.org.uk</H2 -->          <img src="$mklib->images/srou/logo-text.gif" border="0" alt="SimRacing.org.uk logo by The Popabawa" width=480 height=80 />          </a>          </td>	</tr>
<!-- end logostrip -->
