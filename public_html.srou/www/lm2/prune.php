...
$query = $smcFunc['db_query'](null, "
	...
	, IF(CONCAT(',', additional_groups, ',') LIKE '%,103,%', 'Manual reg', NULL) AS manreg
	...
	ORDER BY IF(manreg IS NULL, 0, 1), IFNULL(posts, 0) + IFNULL(events, 0) + IFNULL(pm_sent, 0) + IFNULL(pm_recv, 0) > 0
