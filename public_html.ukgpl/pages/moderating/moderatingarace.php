...
<H1 ALIGN="CENTER">Moderating a Race</H1>
...
<P> When reviewing a race it is useful to run GPL in a window.
...
<H2 ID="modmethod1">Method 1 - Comprehensive Race Review</H2>

<P>The moderator downloads the server replay and reviews the race from each drivers perspective
...
The length of the pit stop can then be calculated from the noted times.</P>

<H3>Advantages</H3>

<UL>

<LI><P>Very thorough.</P>
<LI><P>Most rule transgressions identified easily.</P>
...
<LI><P>Very time consuming.</P>

</UL>

<H2>Method 2 - Textual Reports from GPL Replay Analyser</H2>

<P>The moderator downloads the server replay and processes it using GPL Replay Analyser.
...
drivers fastest lap (not the average lap time). What to regard as <i>significantly
slower</i> depends very much on the driver's ability. The most talented
...
be used to identify shift Rs.</P>

<P>The slow laps and suspected shift Rs are then reviewed manually using the GPL
...
of the time. The length of the pit stop can then be calculated from the noted times.</P>

<H3>Advantages</H3>

<UL>

<LI><P>Easy to identify catastrophic incidents.</P>
<LI><P>Some rule transgressions identified easily (in the report analysis).</P>
<LI><P>Most Shift-Rs are identified in the reports.</P>
<LI><P>Can be reasonably quick, especially for a clean race.</P>
...
<LI><P>Minor incidents which don't result in a lot of lost time can be missed.</P>

<LI><P>Some Shift-Rs are missed by the report generator.</P>
<LI><P>Some rule transgressions, such as the Kyalami pit wall patch, can be missed.</P>

</UL>

<H2>Method 3 - Graphical Reports from GPL Replay Analyser</H2>

<P>The moderator downloads the server replay and processes it using GPL Replay
...
Unfortunately the utility is currently unsupported.</P>
...
stop or it could be a simple driver error.  Potential incidents are noted.</P>

<P>The laps containing potential incidents and suspected shift Rs are then
...
<H2>Method 4 - Reported Incidents</H2>

<P>The moderator downloads the server replay and reviews the incidents reported by
...
<UL>
<LI>Relies on drivers to report incidents.
<LI>Rule transgressions easily missed.
<LI>Some Shift-Rs are missed by the GPL Replay Analyser report generator.
</UL>