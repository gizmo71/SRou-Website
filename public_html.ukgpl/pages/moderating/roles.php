...
<ul>
  ...
  <li><b><font size="4">Publishing the Moderated Race Report </font></b>This involves editing the published results to take into account time penalties etc. It also involves adding incident reports and a race summary to the results page on the website. Again this does require some additional skills in using the "LEAGUE MANAGER 2" application administered by our webmaster.  Details can be found <a href="//www.simracing.org.uk/smf/index.php?topic=362.msg3959#msg3959">here</a>.</li>
...
<p>The League Administrator is responsible for maintaining the UKGPL specific aspects of the web site and forums. The main SRou forum and League Management infrastructure is maintained by the <A HREF="//www.simracing.org.uk/smf/index.php?action=profile;u=1">SRou web master</A>.  In summary, the League Administrator carries out the following tasks:</p>
<ul>
