...
<ul>
  <li><font size="4"><b>Starting the Race Server </b></font>In the absence of the divisional moderator the assistant divisional moderator may be required to start the server. The process is as described above and the necessary IP addresses, port numbers and passwords will be provided. However the assistant divisional moderator will not be able to change the race length since they will not have access to the VNC password. </li>
