...
<H1 ALIGN="CENTER">Technical Regulations</H1>

<H2>General</H2>

<UL>
<LI>Drivers must use Grand Prix Legends version 1.2. The use of the DiscoFix patch is strongly encouraged.</LI>
<BR/>
...
<LI>Modification of the GPL executable and data files is only permitted
	...
	compared to drivers using a copy of GPL without the modification.
	Modifications that have only cosmetic effects are permitted.</LI>
<BR/>
...
<LI>Unless otherwise stated, all UKGPL league races will use the standard 1967 cars as supplied as part of GPL.</LI>
<BR/>
...
<BR/>
<LI>The use of any add-on car choice in addition to the seven cars provided as standard is forbidden.</LI>
<BR/>
